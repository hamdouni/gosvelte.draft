    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(i, file, 39, 35, 1335);
    			attr_dev(span0, "class", "icon is-medium");
    			add_location(span0, file, 39, 5, 1305);
    			add_location(span1, file, 40, 5, 1380);
    			attr_dev(a, "href", "#" + /*item*/ ctx[6].id);
    			attr_dev(a, "class", "navbar-item");
    			add_location(a, file, 38, 4, 1223);
    			this.first = a;
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file, 25, 4, 859);
    			attr_dev(span0, "class", "icon is-medium");
    			add_location(span0, file, 24, 3, 825);
    			add_location(span1, file, 27, 3, 900);
    			attr_dev(div0, "class", "navbar-item is-size-5");
    			add_location(div0, file, 23, 2, 786);
    			add_location(span2, file, 30, 3, 1029);
    			add_location(span3, file, 31, 3, 1046);
    			add_location(span4, file, 32, 3, 1063);
    			attr_dev(div1, "class", "navbar-burger is-hoverable");
    			add_location(div1, file, 29, 2, 935);
    			attr_dev(div2, "class", "navbar-brand");
    			add_location(div2, file, 22, 1, 757);
    			attr_dev(div3, "class", "navbar-start");
    			add_location(div3, file, 36, 2, 1158);
    			attr_dev(a, "href", "/logout");
    			attr_dev(a, "class", "button");
    			add_location(a, file, 47, 5, 1522);
    			attr_dev(div4, "class", "buttons");
    			add_location(div4, file, 46, 4, 1495);
    			attr_dev(div5, "class", "navbar-item");
    			add_location(div5, file, 45, 3, 1465);
    			attr_dev(div6, "class", "navbar-end");
    			add_location(div6, file, 44, 2, 1437);
    			attr_dev(div7, "class", "navbar-menu");
    			toggle_class(div7, "is-active", /*showNavbarMenu*/ ctx[0]);
    			add_location(div7, file, 35, 1, 1095);
    			...
    			add_location(main, file, 54, 0, 1617);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
