...
var app = (function () {
    ...
    // (39:3) {#each Menu as item (item.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t1 = text(t1_value);
    			t2 = space();
    			attr_dev(i, "class", "fas " + /*item*/ ctx[6].icon + " svelte-ozjh55");
    			add_location(i, file, 40, 35, 1350);
    			attr_dev(span0, "class", "icon is-medium");
    			add_location(span0, file, 40, 5, 1320);
    			add_location(span1, file, 41, 5, 1395);
    			attr_dev(a, "href", "#" + /*item*/ ctx[6].id);
    			attr_dev(a, "class", "navbar-item");
    			add_location(a, file, 39, 4, 1238);
    			this.first = a;
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(39:3) {#each Menu as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file, 26, 4, 874);
    			attr_dev(span0, "class", "icon is-medium");
    			add_location(span0, file, 25, 3, 840);
    			add_location(span1, file, 28, 3, 915);
    			attr_dev(div0, "class", "navbar-item");
    			add_location(div0, file, 24, 2, 811);
    			add_location(span2, file, 31, 3, 1044);
    			add_location(span3, file, 32, 3, 1061);
    			add_location(span4, file, 33, 3, 1078);
    			attr_dev(div1, "class", "navbar-burger is-hoverable");
    			add_location(div1, file, 30, 2, 950);
    			attr_dev(div2, "class", "navbar-brand");
    			add_location(div2, file, 23, 1, 782);
    			attr_dev(div3, "class", "navbar-start");
    			add_location(div3, file, 37, 2, 1173);
    			attr_dev(a, "href", "/logout");
    			attr_dev(a, "class", "button");
    			add_location(a, file, 48, 5, 1537);
    			attr_dev(div4, "class", "buttons");
    			add_location(div4, file, 47, 4, 1510);
    			attr_dev(div5, "class", "navbar-item");
    			add_location(div5, file, 46, 3, 1480);
    			attr_dev(div6, "class", "navbar-end");
    			add_location(div6, file, 45, 2, 1452);
    			attr_dev(div7, "class", "navbar-menu svelte-ozjh55");
    			toggle_class(div7, "is-active", /*showNavbarMenu*/ ctx[0]);
    			add_location(div7, file, 36, 1, 1110);
    			attr_dev(nav, "class", "navbar is-fixed-top has-shadow is-light");
    			add_location(nav, file, 22, 0, 727);
    			attr_dev(section, "class", "section");
    			attr_dev(section, "is-main-content", "");
    			add_location(section, file, 54, 0, 1631);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
