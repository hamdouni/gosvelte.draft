...
var app = (function () {
    ...
    /* functions/Login.svelte generated by Svelte v3.37.0 */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Entrer un prénom";
    			t1 = space();
    			input = element("input");
    			t2 = space();
    			button = element("button");
    			...
    			add_location(h1, file$4, 12, 4, 232);
    			attr_dev(input, "name", "name");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Entrer un prénom...");
    			attr_dev(input, "class", "input");
    			add_location(input, file$4, 13, 4, 281);
    			add_location(button, file$4, 15, 4, 392);
    			add_location(hr, file$4, 18, 4, 456);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Entrer le mot ou la phrase à mettre en majuscule";
    			t1 = space();
    			input = element("input");
    			t2 = space();
    			button = element("button");
    			...
    			if (if_block) if_block.c();
    			attr_dev(h1, "class", "title is-2");
    			add_location(h1, file$3, 12, 4, 224);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Entrer le mot ou la phrase à mettre en majuscule...");
    			attr_dev(input, "class", "input");
    			add_location(input, file$3, 13, 4, 305);
    			add_location(button, file$3, 15, 4, 436);
    			add_location(hr, file$3, 18, 4, 498);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Entrer le mot ou la phrase à mettre en minuscule";
    			t1 = space();
    			input = element("input");
    			t2 = space();
    			button = element("button");
    			...
    			if (if_block) if_block.c();
    			attr_dev(h1, "class", "title is-2");
    			add_location(h1, file$2, 12, 4, 224);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Entrer le mot ou la phrase à mettre en minuscule...");
    			attr_dev(input, "class", "input");
    			add_location(input, file$2, 13, 4, 305);
    			add_location(button, file$2, 15, 4, 436);
    			add_location(hr, file$2, 18, 4, 498);
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file$1, 16, 12, 355);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$1, 14, 4, 298);
    ...
    /* functions/Dashboard.svelte generated by Svelte v3.37.0 */
    ...
    function create_each_block_1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t1 = text(t1_value);
    			t2 = space();
    			attr_dev(i, "class", "fas " + /*item*/ ctx[7].icon);
    			add_location(i, file, 39, 35, 1337);
    			attr_dev(span0, "class", "icon is-medium");
    			add_location(span0, file, 39, 5, 1307);
    			add_location(span1, file, 40, 5, 1382);
    			attr_dev(a, "href", "#" + /*item*/ ctx[7].id);
    			attr_dev(a, "class", "navbar-item");
    			add_location(a, file, 38, 4, 1225);
    			this.first = a;
    		},
    		m: function mount(target, anchor) {
    ...
    // (57:3) {#each Menu as item (item.id)}
    function create_each_block(key_1, ctx) {
    	...
    	function click_handler_2() {
    		return /*click_handler_2*/ ctx[6](/*item*/ ctx[7]);
    	}
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t2 = space();
    			attr_dev(i, "class", "fas " + /*item*/ ctx[7].icon);
    			add_location(i, file, 59, 35, 1882);
    			attr_dev(span0, "class", "icon is-medium");
    			add_location(span0, file, 59, 5, 1852);
    			add_location(span1, file, 60, 5, 1927);
    			attr_dev(a, "href", "#" + /*item*/ ctx[7].id);
    			attr_dev(a, "class", "navbar-item");
    			add_location(a, file, 58, 4, 1770);
    			add_location(li, file, 57, 4, 1761);
    			this.first = li;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(57:3) {#each Menu as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file, 25, 4, 861);
    			attr_dev(span0, "class", "icon is-medium");
    			add_location(span0, file, 24, 3, 827);
    			add_location(span1, file, 27, 3, 902);
    			attr_dev(div0, "class", "navbar-item");
    			add_location(div0, file, 23, 2, 798);
    			add_location(span2, file, 30, 3, 1031);
    			add_location(span3, file, 31, 3, 1048);
    			add_location(span4, file, 32, 3, 1065);
    			attr_dev(div1, "class", "navbar-burger is-hoverable");
    			add_location(div1, file, 29, 2, 937);
    			attr_dev(div2, "class", "navbar-brand");
    			add_location(div2, file, 22, 1, 769);
    			attr_dev(div3, "class", "navbar-start");
    			add_location(div3, file, 36, 2, 1160);
    			attr_dev(a, "href", "/logout");
    			attr_dev(a, "class", "button");
    			add_location(a, file, 47, 5, 1524);
    			attr_dev(div4, "class", "buttons");
    			add_location(div4, file, 46, 4, 1497);
    			attr_dev(div5, "class", "navbar-item");
    			add_location(div5, file, 45, 3, 1467);
    			attr_dev(div6, "class", "navbar-end");
    			add_location(div6, file, 44, 2, 1439);
    			attr_dev(div7, "class", "navbar-menu");
    			toggle_class(div7, "is-active", /*showNavbarMenu*/ ctx[0]);
    			add_location(div7, file, 35, 1, 1097);
    			attr_dev(nav, "class", "navbar is-fixed-top has-shadow is-light has-background-warning");
    			add_location(nav, file, 21, 0, 691);
    			attr_dev(ul, "class", "menu-list");
    			add_location(ul, file, 55, 2, 1700);
    			attr_dev(aside, "class", "menu column is-2 has-background-primary");
    			add_location(aside, file, 54, 1, 1642);
    			attr_dev(section, "class", "column is-10");
    			add_location(section, file, 66, 1, 2002);
    			attr_dev(main, "class", "columns");
    			add_location(main, file, 53, 0, 1618);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const click_handler_2 = item => activate(item.id);
